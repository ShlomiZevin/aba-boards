...
DEPLOY_CMD="gcloud run deploy $SERVICE_NAME \
  ...
  --set-env-vars OPENAI_API_KEY=$OPENAI_API_KEY,ELEVENLABS_API_KEY=$ELEVENLABS_API_KEY,ANTHROPIC_API_KEY=$ANTHROPIC_API_KEY,PAYPAL_CLIENT_ID=$PAYPAL_CLIENT_ID,PAYPAL_CLIENT_SECRET=$PAYPAL_CLIENT_SECRET,PAYPAL_MONTHLY_PLAN_ID=$PAYPAL_MONTHLY_PLAN_ID,PAYPAL_YEARLY_PLAN_ID=$PAYPAL_YEARLY_PLAN_ID,PAYPAL_WEBHOOK_ID=$PAYPAL_WEBHOOK_ID,PAYPAL_MODE=$PAYPAL_MODE,APP_BASE_URL=$APP_BASE_URL"
